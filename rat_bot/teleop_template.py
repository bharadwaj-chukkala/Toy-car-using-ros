...
if __name__=="__main__":
    ...
    pub_move = rospy.Publisher('/rat_bot/rear_axle_continuous_controller/command', Float64, queue_size=10)
    # pub_right_wheel_move = rospy.Publisher('/rat_bot/front_right_wheel_controller/command', Float64, queue_size=10)
    # pub_left_wheel_move = rospy.Publisher('/rat_bot/front_left_wheel_controller/command', Float64, queue_size=10)
